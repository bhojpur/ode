...
<xsl:transform
	...
	xmlns:CA = "http://www.bhojpur.net/XMLschemas/CA/RC1/CA.xsd"
	...
	xmlns = "http://www.bhojpur.net/XMLschemas/ODE/FC/ode.xsd">
	...
	<!-- Global CAs -->
	<xsl:template match = "CA:ODE/CA:CustomAttributes" mode = "pass-through-CAs">
	...
	<xsl:template match = "CA:ODE">
		<xsl:element name = "ODE"
			namespace = "http://www.bhojpur.net/XMLschemas/ODE/FC/ode.xsd"
			xmlns = "http://www.bhojpur.net/XMLschemas/ODE/FC/ode.xsd">
	...
	<xsl:template match = "@*" mode = "MakeODEref">
	...
	<!-- Specific sections of the Bhojpur ODE Schema -->
	<xsl:template match = "CA:Project">
		<xsl:element name = "Project">
			...
			<xsl:apply-templates select = "@Experimenter" mode = "MakeODEref"/>
			<xsl:apply-templates select = "@Group" mode = "MakeODEref"/>
		</xsl:element>
	</xsl:template>
	<xsl:template match = "CA:Dataset">
		<xsl:element name = "Dataset">
			...
			<xsl:apply-templates select = "@Experimenter" mode = "MakeODEref"/>
			<xsl:apply-templates select = "@Group" mode = "MakeODEref"/>
			<xsl:apply-templates select = "CA:ProjectRef" mode = "MakeODEref"/>
			<xsl:apply-templates select = "CA:CustomAttributes" mode = "pass-through-CAs"/>
		</xsl:element>
	</xsl:template>
...
-->
			...
			<xsl:apply-templates select = "@Group" mode = "MakeODEref"/>
			<xsl:apply-templates select = "CA:DatasetRef" mode = "MakeODEref"/>
	...
	<xsl:template match = "CA:ImageExperiment">
		<xsl:apply-templates select = "@Experiment" mode = "MakeODEref"/>
	</xsl:template>
	...
	<xsl:template match = "CA:Plate">
		...
		<xsl:element name = "Plate">
			...
			<xsl:apply-templates select = "../CA:PlateScreen/@Screen [../@Plate=$ID]" mode = "MakeODEref"/>
		</xsl:element>
	</xsl:template>
	...
	<xsl:template match = "CA:Experimenter">
		...
		<xsl:element name = "Experimenter">
			...
			<xsl:apply-templates select = "@Group" mode = "MakeODEref"/>
			<xsl:apply-templates select = "../CA:ExperimenterGroup/@Group [../@Experimenter=$ID]" mode = "MakeODEref"/>
		</xsl:element>
	</xsl:template>
	<xsl:template match = "CA:Group">
		<xsl:element name = "Group">
			...
			<xsl:apply-templates select = "@Leader" mode = "MakeODEref">
				<xsl:with-param name = "RefName">
					<xsl:text>Leader</xsl:text>
				</xsl:with-param>
			</xsl:apply-templates>
			<xsl:apply-templates select = "@Contact" mode = "MakeODEref">
				<xsl:with-param name = "RefName">
	...
	<xsl:template match = "CA:LightSource">
		...
		<xsl:element name = "LightSource">
			...
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:Laser [@LightSource=$ID]"/>
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:Filament [@LightSource=$ID]"/>
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:Arc [@LightSource=$ID]"/>
		</xsl:element>
	</xsl:template>
	<xsl:template match = "CA:Laser">
		<xsl:element name = "Laser">
			...
			<xsl:apply-templates select = "@Pump" mode = "MakeODEref">
				<xsl:with-param name = "RefName">
	...
	<xsl:template match = "CA:Filter">
		...
		<xsl:element name = "Filter">
			...
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:FilterSet [@Filter=$ID]"/>
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:ExcitationFilter [@Filter=$ID]"/>
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:EmissionFilter [@Filter=$ID]"/>
			<xsl:apply-templates select = "/CA:ODE/CA:CustomAttributes/CA:Dichroic [@Filter=$ID]"/>
		</xsl:element>
	</xsl:template>
	...
	<xsl:template match = "CA:OTF">
		<xsl:element name = "OTF">
			...
			<xsl:apply-templates select = "@Objective" mode = "MakeODEref"/>
			<xsl:apply-templates select = "@Filter" mode = "MakeODEref"/>
		</xsl:element>
	</xsl:template>
	...
	<xsl:template match = "CA:LogicalChannel">
		...
		<xsl:element name = "ChannelInfo">
			...
			<xsl:apply-templates select = "@OTF" mode = "MakeODEref"/>

(function() {
    ...
    window.ODE.Histogram = function(element, webgatewayUrl, graphWidth, graphHeight) {
    ...
    window.ODE.createViewportHistogram = function(viewport, chartSelector, checkboxSelector, webgatewayUrl) {
        var histogram;
        var currChIdx;
        ...
        var showHistogram = function() {
            ...
            if (!histogram) {
                histogram = new ODE.Histogram(chartSelector, webgatewayUrl, plotWidth, 125);
                plotHistogram();
            }
        };
        ...
        $(checkboxSelector).on('click', function(){
            ...
            if (ODE.setPaneExpanded) {
                ODE.setPaneExpanded('histogram', show);
            }
            if (show) {
                showHistogram();
            } else {
        ...
        if (ODE.getPaneExpanded && ODE.getPaneExpanded('histogram')) {

/**
 * webode-plateview - Webode plate viewport
 *
 * Depends on jquery
 */
 ...
 * - Initializing -
 *
 * plate = jQuery.WebodePlateview(elm, options)
 ...
 * - returns the WebodePlateview object
 *
 * - Using -
 *
...
;jQuery.fn.WebodePlateview = function (options) {
    return this.each
    (
     function () {
       if (!this.WebodePlateview)
     this.WebodePlateview = new jQuery._WebodePlateview (this, options);
     });
  };
  
  jQuery.WebodePlateview = function (elm, options) {
    var container = jQuery(elm).get(0);
    if (container === undefined) return null;
      var rv = container.WebodePlateview || (container.WebodePlateview = new jQuery._WebodePlateview(container, options));
    return rv;
  };
  ...
  /**
   * _WebodePlateview class created in the jQuery namespace holds all logic for interfacing with the webode
   * plate and ajax server.
   */
  
  jQuery._WebodePlateview = function (container, options) {
    ...
    this.self.addClass('webode-plateview');

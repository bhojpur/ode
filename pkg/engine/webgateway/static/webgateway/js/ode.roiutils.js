// get a shape configuration described as a dictionary compatible with ODE.web viewer
...
// get a rectangle configuration described as a dictionary compatible with ODE.web viewer
$.fn.get_ode_rectangle = function(x, y, height, width, z_plane, t_plane, transform, shape_config) {
...
// get a point configuration described as a dictionary compatible with ODE.web viewer
$.fn.get_ode_point = function(center_x, center_y, z_plane, t_plane, transform, shape_config) {
    // if no shape_config was given, use the default one
    var shape_config = typeof shape_config !== "undefined" ? shape_config : $.fn.get_shape_config();
...
// get an ellipse configuration described as a dictionary compatible with ODE.web viewer
$.fn.get_ode_ellipse = function(center_x, center_y, radius_x, radius_y, z_plane, t_plane,
    ...
    $.extend(ellipse_conf, $.fn.get_ode_point(center_x, center_y, z_plane, t_plane,
        transform, shape_config));
...
// get a line configuration described as a dictionary compatible with ODE.web viewer
$.fn.get_ode_line = function(x1, y1, x2, y2, z_plane, t_plane, transform, shape_config) {
    // if no shape_config was given, use the default one
    var shape_config = typeof shape_config !== "undefined" ? shape_config : $.fn.get_shape_config();
...
// get a label configuration described as a dictionary compatible with ODE.web viewer
$.fn.get_ode_label = function(x, y, text_value, z_plane, t_plane, transform,
...
// get a polygon configuration described as a dictionary compatible with ODE.web viewer
$.fn.get_ode_polygon = function(points, z_plane, t_plane, transform, shape_config) {
    // if no shape_config was given, use the default one
    var shape_config = typeof shape_config !== "undefined" ? shape_config : $.fn.get_shape_config();

...
// ODE.setOpenWithEnabledHandler("Image viewer", function(selected) {
...
ODE.setOpenWithUrlProvider("Image viewer", function(selected, url) {
    ...
    if ($ && $.jstree) {
        try {
            ...
            var parent = ODE.getTreeImageContainerBestGuess(selected[0].id);

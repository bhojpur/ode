...
ODE.nav = {};
ODE.nav.hide_left_panel = function() {
    var lp = $("#left_panel");
...
ODE.nav.show_left_panel = function() {
    var lp = $("#left_panel");
...
ODE.nav.hide_right_panel = function() {
    var rp = $("#right_panel");
...
ODE.nav.show_right_panel = function() {
    var rp = $("#right_panel");
...
ODE.nav.set_right_panel_width = function(pixels) {
    $("#right_panel").css('width', pixels+'px');
    ODE.nav.show_right_panel();
}
...
$(document).ready(function() 
    {
        $('#swapTree').on('click', function() { 
            ...
            if (flag_l) {
                ODE.nav.hide_left_panel();
                flag_l = false;
            } else {
                ODE.nav.show_left_panel();
                flag_l = true;
            }
        });

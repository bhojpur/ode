...
import ode.xml.model.enums.UnitsTime;
import ode.xml.model.primitives.PrimitiveNumber;
...
public final class FormatTools {
  ...
  static
  {
    ...
    CREATOR = "Bhojpur ODE-Formats " + VERSION;
  ...
  /** URL of ODE-Formats web page. */
  public static final String URL_BIO_FORMATS =
    "https://www.bhojpur.net/ode-formats";

  /** URL of 'ODE-Formats as a Java Library' web page. */
  public static final String URL_BIO_FORMATS_LIBRARIES =
    "https://docs.bhojpur.net/ode-formats/" + VERSION + "/developers/java-library.html";

  /** URL of ODE-TIFF web page. */
  public static final String URL_ODE_TIFF =
    "https://docs.bhojpur.net/latest/ode-model/ode-tiff/";
    ...
    throws FormatException, IOException
  {
    ...
    try {
      ...
      reader.setMetadataStore(service.createODEXMLMetadata());
    }
  ...
  // -- ODE-XML primitive type methods --

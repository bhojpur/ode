...
classdef TestBfGetReader < ReaderTest
    ...
    methods
        ...
        function testGetPixelsPhysicalSizeX(self)
            ...
            assertEqual(char(physicalSizeX.unit().getSymbol()), '�m');
            assertElementsAlmostEqual(physicalSizeX.value(ode.units.UNITS.NANOMETER).doubleValue(), 300.0);
        end
        ...
        function testGetPixelsPhysicalSizeY(self)
            ...
            assertEqual(char(physicalSizeY.unit().getSymbol()), '�m');
            assertElementsAlmostEqual(physicalSizeY.value(ode.units.UNITS.NANOMETER).doubleValue(), 300.0);
        end
        ...
        function testGetPixelsPhysicalSizeZ(self)
            ...
            assertEqual(char(physicalSizeZ.unit().getSymbol()), '�m');
            assertElementsAlmostEqual(physicalSizeZ.value(ode.units.UNITS.NANOMETER).doubleValue(), 300.0);
        end
        ...
        function testJavaMethod(self)
            ...
            ODEXMLService = loci.formats.services.ODEXMLServiceImpl();
            ODEXMLService1 = javaObject('loci.formats.services.ODEXMLServiceImpl');
            assertEqual(ODEXMLService.getClass(),ODEXMLService1.getClass());
            
            self.reader.setMetadataStore(ODEXMLService1.createODEXMLMetadata());
        end

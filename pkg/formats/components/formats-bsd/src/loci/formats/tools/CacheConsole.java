 ...
 * testing the ODE-Formats caching implementation.
 */
public final class CacheConsole {
  ...
  /** Interactive interpreter for testing ODE-Formats caching implementation. */
  public static void main(String[] args) throws FormatException, IOException {
    ...
    System.out.println("Entering ODE-Formats caching test console");
    while (true) {
      System.out.print("> ");
